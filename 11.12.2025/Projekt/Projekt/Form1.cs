...
namespace Projekt
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "") 
            {
                ...
                else if (label3.Text == "Quiz")
                {
                    string[] pytania;
                    float[] odpowiedzi;
                    float poprawna = 0;
                    odpowiedzi = new float[4];
                    pytania = new string[4];
                    pytania[0] = "Podaj pole kwadratu o boku 4";
                    pytania[1] = "Podaj pole prostokątu o bokach 5 i 4";
                    pytania[2] = "Podaj obwód koła o promieniu 2 do dwóch miejsc po przecinku";
                    pytania[3] = "Oblicz objętość walca o promieniu 3 i wysokości 2 do dwóch miejsc po przecinku";
                    pytania[4] = "Oblicz pole powierzchni kuli o promieniu 3 do dwóch miejsc po przecinku";
                    odpowiedzi[0] = 16;
                    odpowiedzi[1] = 20;
                    odpowiedzi[2] = 12.56f;
                    odpowiedzi[3] = 56.52f;
                    odpowiedzi[4] = 113.04f;
                    float odp = float.Parse(textBox2.Text);
                    int punkty = 0;

                    for (int i = 0; i <= 5; i++)
                    {
                        label4.Text = pytania[i];
                        poprawna = odpowiedzi[i];
                        if(odp == poprawna)
                        {
                            punkty++;
                        }
 ...
 //jezeli nazwisko kowalski to wyskoczy okienko z komunikatem nazwisko + "ostatni wynik z testu to: punkty"
 //jesli nie znajdzie to komunikat kowalski "rozwiazujesz test po raz pierwszy"
 //jak w quizie beda wszystkie odpowiedzi juz, wypisujemy wynik w messagebox
        }
